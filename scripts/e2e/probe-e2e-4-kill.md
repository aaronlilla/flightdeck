# E2E console probe (run 4: throwaway, kill target for the fixed kill path)
...
7. Run the Bash command `sleep 20 && echo tick7`. Then write: `tick 7`.
8. Run the Bash command `sleep 20 && echo tick8`. Then write: `tick 8`.
