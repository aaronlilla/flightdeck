...
function lane(extra: Partial<Lane> = {}): Lane {
  return {
    ...
    pr: null, sandbox: null, blockedBy: null, runaway: false, needsAaron: null, live: { alive: false, pid: null, lastEventAt: null, checkedAt: 0 }, did: null, now: '', you: null,
    ...extra,
  };
}
...
function integration(extra: Partial<Integration> = {}): Integration {
  return {
    ...
    scope: null, lastHealthyAt: null, retryCount: 0, mcpState: null, lastError: null,
    ...extra,
  };
}
