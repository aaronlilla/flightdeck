...
const CASES: Record<string, Case> = {
  ...
  sendToRun: { args: ['L-1', 'try the other branch'], result: { ...OK, message: 'sent to L-1' }, text: 'sent to L-1' },
  ...
  sendCommand: { args: ['what is stuck'], result: { cards: [{ k: 'r', type: 'receipt', text: 'two lanes are waiting on you', ts: 0, source: 'conductor' }] }, text: 'two lanes are waiting on you' },
