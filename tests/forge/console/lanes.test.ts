...
describe('windowLanes', () => {
  ...
  function laneWith(overrides: Partial<Lane>): Lane {
    return {
      ...
      blockedBy: null, runaway: false, needsAaron: null, did: null, didVerbatim: false, now: '', you: null, live: { alive: false, pid: null, lastEventAt: null, checkedAt: 0 },
      ...overrides,
    };
  }
...
describe('mergeReadyReportFrom', () => {
  function laneWithPr(overrides: Partial<Lane>): Lane {
    return {
      ...
      needsAaron: null, mergeable: null, did: null, didVerbatim: false, now: '', you: null, live: { alive: false, pid: null, lastEventAt: null, checkedAt: 0 },
