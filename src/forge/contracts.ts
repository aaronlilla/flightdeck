...
export const FORGE_EVENT_NAMES = [
  ...
  // R-11: the Jira watcher's own tick failure, the same shape as `queue.tick-error`
  // above -- one row per poll that threw before any add/send/close reached the queue.
  'watcher.tick-error',
