...
const DEFAULT_COUNCIL_POLICY: CouncilPolicy = {
  smallMaxLines: 100,
  largeMinLines: 500,
  // Money and identity code, named by GENERIC vocabulary rather than one product's
  // vendors. A 36-line change to `src/money.js` earned exactly one reviewer and no
  // independent lane because it matched no vendor word -- and blast radius in money
  // code is decoupled from line count.
  riskyPaths: [
    '**/features/wallet/**', '**/features/auth/**', '**/Financial/**',
    '**/*money*',
    '**/*money*/**',
    '**/*Money*',
    '**/*Money*/**',
