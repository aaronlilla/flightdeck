 ...
 * 2026-09-08): a brief under a goals directory (`.claude/goals/*.md`) with a sibling
 * `*.block.txt` holding the literal `/goal ...` block a fresh session would paste in, or
 * an exported task Markdown file carrying a fenced
