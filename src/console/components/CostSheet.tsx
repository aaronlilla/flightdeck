    ...
    <div className="plate" data-testid="cost-sheet" style={{ width: 'min(820px, calc(100vw - 48px))', minWidth: 'min(520px, calc(100vw - 48px))', maxHeight: 'calc(100vh - 48px)', overflowY: 'auto', boxSizing: 'border-box' }}>
      ...
      <div style={{ padding: '18px 22px', display: 'flex', flexDirection: 'column', gap: 14 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 18 }}>
          ...
          <div className="m" style={{ fontSize: 'var(--fs-body)', lineHeight: 1.8, color: 'var(--ink2)' }}>
        ...
        {loadFailed ? (
          <div className="m" style={{ fontSize: 'var(--fs-body)', color: 'var(--block)' }}>could not load the step breakdown.</div>
        ) : null}
