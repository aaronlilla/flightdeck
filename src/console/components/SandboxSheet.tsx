...
export function SandboxSheet({ lane, onClose, onCopiedPath }: SandboxSheetProps): JSX.Element {
  ...
  return (
    <div className="plate" data-testid="sandbox-sheet" style={{ width: 'min(920px, calc(100vw - 48px))', minWidth: 'min(620px, calc(100vw - 48px))', maxHeight: 'calc(100vh - 48px)', overflowY: 'auto', boxSizing: 'border-box' }}>
      ...
      <div style={{ padding: '16px 22px', display: 'flex', flexDirection: 'column', gap: 12 }}>
        ...
        <div style={{ background: 'var(--well)', borderRadius: 3, padding: '12px 14px', boxShadow: 'inset 0 2px 5px rgba(0,0,0,.6)' }}>
          <div className="m" style={{ fontSize: 'var(--fs-body)', lineHeight: 1.9, color: '#9aa08c' }}>
            {loadFailed
