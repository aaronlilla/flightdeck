...
export function FleetCostSheet({ lanes, tokensToday, onClose, onOpenLane }: FleetCostSheetProps): JSX.Element {
  ...
  return (
    <div className="plate" data-testid="fleet-cost-sheet" style={{ width: 'min(940px, calc(100vw - 48px))', minWidth: 'min(640px, calc(100vw - 48px))', maxHeight: 'calc(100vh - 48px)', overflowY: 'auto', boxSizing: 'border-box' }}>
