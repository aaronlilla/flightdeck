...
export function TopBar(props: TopBarProps): JSX.Element {
  ...
  return (
    ...
    >
      ...
      <span className="m" style={{ fontSize: 'var(--fs-meta)', color: 'var(--ink3)', border: '1px solid var(--line2)', borderRadius: 3, padding: '4px 10px', cursor: 'pointer' }} onClick={onOpenPalette}>
        ⌘K jump
      </span>
      ...
      <ActionButton spec={ACTIONS.stopAll} args={[]} actionRef="topbar" className="btnR" style={{ padding: '5px 10px', fontSize: 'var(--fs-meta)' }} busy="Stopping…">Stop all</ActionButton>
