  ...
  return [
    {
      ...
      scope: null, lastHealthyAt: now, retryCount: 0, dependents: [], step: null, links: {},
    },
    {
    ...
    },
    {
      ...
      fixLabel: null, scope: null, lastHealthyAt: now, retryCount: 0, dependents: [], step: null, links: {},
    },
    {
    ...
    },
    {
      ...
      status: 'ok', checkedAt: now, since: null, cause: null, effect: null, fix: null, fixLabel: null,
      scope: null, lastHealthyAt: now, retryCount: 0, dependents: [], step: null, links: { tools: '#', logs: '#' },
    },
    {
    ...
    },
    {
      ...
      scope: null, lastHealthyAt: now - 5 * 60_000, retryCount: 0, dependents: [], step: null, links: { tools: '#', logs: '#' },
    },
    {
