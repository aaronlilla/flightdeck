...
| R-59 | flightdeck gates its own Jira and PR writes on the Joe rule again, contract and specimens loaded from the machine | autonomy | planned | this PR | agnostic check exit 0; neutral specimen suite pinned at 8; installer test red then green; unconfigured/on-line tested both ways |
